...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by Peroxide's Upvalue Scanner: https://github.com/yuup-lol/Peroxide
-- Upvalue Scanner fix by Deni210: https://github.com/Deni210
local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/yuup-lol/Peroxide/revision/ohaux.lua"))()
